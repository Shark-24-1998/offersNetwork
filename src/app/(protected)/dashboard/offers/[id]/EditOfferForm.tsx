...
import { MdLocalOffer, MdAdd, MdEdit } from "react-icons/md";
...
type Offer = {
  ...
  rewardsValue: string | null;
  tierWiseSteps: TierWiseSteps;
  maxPerTaskTierWise: MaxPerTaskTierWise;
...
export default function EditOfferForm({ offer }: OfferFormProps) {
  ...
  const [bannerImage, setBannerImage] = useState(offer.bannerImage ?? "");
  const [squareImage, setSquareImage] = useState(offer.squareImage ?? "");
  const [rewardsValue, setRewardsValue] = useState(offer.rewardsValue ?? "");
console.log("EDIT PAGE OFFER:", offer);
  ...
  const [maxPerTaskTierWise, setMaxPerTaskTierWise] =
    useState<MaxPerTaskTierWise>(offer.maxPerTaskTierWise);
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 px-4 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-gray-900 placeholder:text-gray-400"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 pl-10 pr-4 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-gray-900 placeholder:text-gray-400"
                  required
                />
              </div>
            </div>
        ...
        <div className="rounded-2xl border border-purple-100 bg-white p-5 sm:p-6 shadow-md shadow-purple-500/5">
          ...
          {Object.keys(tierWiseSteps).length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">No tiers added yet. Click &quot;Add Tier&quot; to create one.</p>
            </div>
          ) : (
            <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full sm:w-48 border border-gray-300 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-gray-900 placeholder:text-gray-400"
                        required
                      />
                    </div>
                      ...
                      {steps.map((step, i) => (
                        <div key={i} className="flex gap-2">
                          <input
                            ...
                            className="flex-1 border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 placeholder:text-gray-400"
                            required
                          />
                          <input
                            type="number"
                            ...
                            className="w-28 border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 placeholder:text-gray-400"
                            required
                          />
                          <button
                            type="button"
